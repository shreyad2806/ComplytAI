...
import { Bot, FileSearch, LayoutGrid, ShieldAlert } from "lucide-react";
import { cn } from "@/lib/utils";

const items = [
  { href: "/dashboard", label: "Dashboard", icon: LayoutGrid },
  { href: "/dashboard#documents", label: "Docs", icon: FileSearch },
        ...
        {items.map((item) => (
          <Link
            ...
            className={cn(
              ...
              pathname === item.href && "bg-cyan-500/10 text-cyan-200"
            )}
          >
